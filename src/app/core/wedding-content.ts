...
export const WEDDING_CONTENT: WeddingContent = {
  ...
  program: [
    ...
    {
      time: '18:00 - 18:30',
      title: 'Момент, которого мы очень ждём',
      room: 'Library',
      details:
        'Ровно в 18:00 начнётся самый волнительный момент нашего дня.\n\nВ одном из залов, в окружении семьи и друзей, состоится выездная регистрация. Для нас большая радость разделить этот момент вместе с вами.',
